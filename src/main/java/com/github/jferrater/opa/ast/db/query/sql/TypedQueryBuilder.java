...
public class TypedQueryBuilder<T> {
    ...
    <S extends T>Predicate orPredicates(Root<S> root) {
        List<List<com.github.jferrater.opa.ast.db.query.model.response.Predicate>> opaPredicates = opaCompilerResponse.getResult().getQueries();
    ...
    <S extends T>Predicate andPredicates(List<com.github.jferrater.opa.ast.db.query.model.response.Predicate> opaPredicateObjList, Root<S> root){
    ...
    <U extends T> List<Predicate> getPredicatesFromOpaResponse(
            List<com.github.jferrater.opa.ast.db.query.model.response.Predicate> opaPredicateObjList,
            Root<U> root) {
